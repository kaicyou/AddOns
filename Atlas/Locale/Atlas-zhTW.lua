-- $Id: Atlas-zhTW.lua 31 2016-06-23 07:30:35Z arith $
--[[
...
L["ATLAS_DDL_CONTINENT"] = "依不同大陸分類" -- Needs review
...
L["ATLAS_DDL_EXPANSION"] = "依資料片分類" -- Needs review
...
L["ATLAS_DDL_LEVEL"] = "依等級分類" -- Needs review
...
L["ATLAS_DDL_PARTYSIZE"] = "依隊伍人數分類" -- Needs review
...
L["ATLAS_DDL_TYPE"] = "依地圖類型分類" -- Needs review
...
L["ATLAS_STRING_LEVELRANGE"] = "等級範圍" -- Needs review
L["ATLAS_STRING_LOCATION"] = "所在位置"
L["ATLAS_STRING_MINLEVEL"] = "最低等級"
L["ATLAS_STRING_PLAYERLIMIT"] = "人數上限"
L["ATLAS_STRING_RECLEVELRANGE"] = "建議等級" -- Needs review
