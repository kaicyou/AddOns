-- $Id: Atlas_Transportation.lua 23 2016-07-01 10:20:35Z arith $
--[[
...
local myData = {
	...
	TransAllianceDraenor = {
		...
		{ _RED..AL["Portals"] };
		{ PURP.." A) "..BZ["Khadgar's Tower"]..", "..BZ["Talador"], 10052 };
		{ PURP.." A') "..BZ["Darnassus"]..", "..BZ["Teldrassil"]..", "..BZ["Kalimdor"], 10053 };
		{ PURP.." B') "..BZ["Ironforge"]..", "..BZ["Dun Morogh"]..", "..BZ["Eastern Kingdoms"], 10054 };
		{ PURP.." C') "..BZ["Stormwind City"]..", "..BZ["Elwynn Forest"]..", "..BZ["Eastern Kingdoms"], 10055 };
		{ NUTL.."19) "..BZ["Zangarra"]..", "..BZ["Talador"] };
		{ "" };
		{ _RED..AL["Taxi Nodes"] };
		...
		{ "" };
		{ _RED..AL["Legend"] };
		{ PURP..AL["Purple"]..": "..AL["Portals"] };
		{ NUTL..AL["Yellow"]..": "..AL["Taxi Nodes"].." - "..AL["Nutral"] };
		{ ALAN..AL["Blue"]..": "..AL["Taxi Nodes"].." - "..FACTION_ALLIANCE };
		{ WHIT..AL["White"]..": "..AL["Special transportation"] };
	...
	TransHordeDraenor = {
		...
		{ _RED..AL["Portals"] };
		{ PURP.." A) "..BZ["Khadgar's Tower"]..", "..BZ["Talador"], 10051 };
		{ PURP.." A') "..BZ["Orgrimmar"]..", "..BZ["Durotar"]..", "..BZ["Kalimdor"], 10052 };
		{ PURP.." B') "..BZ["Thunder Bluff"]..", "..BZ["Mulgore"]..", "..BZ["Kalimdor"], 10053 };
		{ PURP.." C') "..BZ["Undercity"]..", "..BZ["Tirisfal Glades"]..", "..BZ["Eastern Kingdoms"], 10054 };
		{ NUTL.."18) "..BZ["Zangarra"]..", "..BZ["Talador"] };
		{ "" };
		{ _RED..AL["Taxi Nodes"] };
		{ BLUE..BZ["Frostfire Ridge"] };
		...
		{ PURP..AL["Purple"]..": "..AL["Portals"] };
		{ NUTL..AL["Yellow"]..": "..AL["Taxi Nodes"].." - "..AL["Nutral"] };
		{ HRDE..AL["Red"]..": "..AL["Taxi Nodes"].." - "..FACTION_HORDE };
		{ WHIT..AL["White"]..": "..AL["Special transportation"] };
		{ PURP.."-- : "..AL["Portal / Waygate Path to the destination"] };
		{ CYAN.."-- : "..AL["Airship"] };
	};
	...
	TransAllianceEast = {
		...
		{ GREY..INDENT.."("..AL["Only available after winning the PvP battle"]..")" };
		...
		{ PURP.." E') "..BZ["Temple of Earth"]..", "..BZ["Deepholm"] };
		{ PURP.." F') "..BZ["Darkmoon Island"] };
		{ PURP.." G') "..BZ["Paw'Don Village"]..", "..BZ["The Jade Forest"]..", "..BZ["Pandaria"] };
		...
		{ WHIT.."13) "..BZ["Andorhal"] };
		{ GREY..INDENT.."("..AL["Won't be available once the Battle for Andorhal chain is finished."]..")" };
		...
		{ "" };
		{ BLUE..BZ["Vashj'ir"] };
		{ CYAN.."64) "..BZ["Smuggler's Scar"].." ("..AL["Seahorse"]..")" };
		{ CYAN.."65) "..BZ["Sandy Beach"].." ("..AL["Seahorse"].." / "..AL["Gryphon"]..")" };
		{ CYAN.."66) "..BZ["Silver Tide Hollow"].." ("..AL["Seahorse"]..")" };
		{ CYAN.."67) "..BZ["Tranquil Wash"].." ("..AL["Seahorse"]..")" };
		{ CYAN.."68) "..BZ["Voldrin's Hold"].." ("..AL["Seahorse"].." / "..AL["Gryphon"]..")" };
		{ CYAN.."69) "..BZ["Darkbreak Cove"].." ("..AL["Seahorse"]..")" };
		{ "" };
		{ _RED..AL["Legend"] };
		{ PURP.."-- : "..AL["Portal / Waygate Path to the destination"] };
	...
	TransHordeEast = {
		...
		{ WHIT.."51) "..BZ["Shattered Landing"]..", "..BZ["Blasted Lands"] };
		{ "" };
		{ _RED..AL["Taxi Nodes"] };
		{ BLUE..BZ["Isle of Quel'Danas"] };
		{ WHIT.." 1) "..BZ["Shattered Sun Staging Area"] };
	...
	TransHordeOrgrimmar = {
		...
		{ PURP.." G) "..BZ["Nordrassil"]..", "..BZ["Mount Hyjal"], 10007 };
	...
	TransAlliancePandaria = {
		...
		{ PURP.." C) "..BZ["Shan'ze Dao"]..", "..BZ["Townlong Steppes"] };
		{ PURP.." D) "..BZ["The Skyfire"]..", "..BZ["Krasarang Wilds"] };
		{ PURP.." A') "..BZ["Stormwind City"]..", "..BZ["Elwynn Forest"]..", "..BZ["Eastern Kingdoms"] };
		...
		{ PURP.." E') "..BZ["Darnassus"]..", "..BZ["Teldrassil"]..", "..BZ["Kalimdor"] };
		{ PURP.." F') "..BZ["Ratchet"]..", "..BZ["Northern Barrens"]..", "..BZ["Kalimdor"] };
		{ PURP.." G') "..BZ["Shattrath City"]..", "..BZ["Terokkar Forest"]..", "..BZ["Outland"] };
		{ "" };
	...
	TransHordePandaria = {
		...
		{ PURP.." C) "..BZ["Shan'ze Dao"]..", "..BZ["Townlong Steppes"] };
		{ PURP.." D) "..BZ["Sparkrocket Outpost"]..", "..BZ["Krasarang Wilds"] };
		{ PURP.." E) "..BZ["Ruins of Ogudei"]..", "..BZ["Krasarang Wilds"] };
		{ PURP.." A') "..BZ["Orgrimmar"]..", "..BZ["Durotar"]..", "..BZ["Kalimdor"] };
		{ PURP.." B') "..BZ["Thunder Bluff"]..", "..BZ["Mulgore"]..", "..BZ["Kalimdor"] };
		{ PURP.." C') "..BZ["Ratchet"]..", "..BZ["Northern Barrens"]..", "..BZ["Kalimdor"] };
		{ PURP.." D') "..BZ["Shattrath City"]..", "..BZ["Terokkar Forest"]..", "..BZ["Outland"] };
		{ PURP.." E') "..BZ["Dalaran"]..", "..BZ["Crystalsong Forest"]..", "..BZ["Northrend"] };
		{ PURP.." F') "..BZ["Silvermoon City"]..", "..BZ["Eversong Woods"]..", "..BZ["Eastern Kingdoms"] };
		{ PURP.." G') "..BZ["Undercity"]..", "..BZ["Tirisfal Glades"]..", "..BZ["Eastern Kingdoms"] };
		{ "" };
		{ _RED..AL["Special transportation"] };
		{ ORNG.." A) "..BZ["The Arboretum"]..", "..BZ["The Jade Forest"] };
		{ INDENT..GREY..AL["Abandoned Kite"].." ("..AL["From sea level to ground level"]..")" };
