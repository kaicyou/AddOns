...
L["EXPIRED_EMAILS_WARNING"] = "%s (%s) hat verfallene (oder bald verfallende) Post" -- Needs review
...
L["REPORT_EXPIRED_MAILS_DISABLED"] = "Im Chatfenster wird nichts angezeigt werden" -- Needs review
L["REPORT_EXPIRED_MAILS_ENABLED"] = "Während der Brief-Verfall Überprüfung wird die Liste der Charaktere mit verfallenen Briefen auch im Chatfenster angezeigt." -- Needs review
L["REPORT_EXPIRED_MAILS_LABEL"] = "Brief-Verfall Warnung (Chatfenster)" -- Needs review
L["REPORT_EXPIRED_MAILS_TITLE"] = "Brief-Verfall Warnung (Chatfenster)" -- Needs review
