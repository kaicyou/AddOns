...
LSM:Register(font,"PT Sans Narrow", [[Interface\AddOns\ElvUI\media\fonts\PT_Sans_Narrow.ttf]], ruRU + western + zhCN)
LSM:Register(font, "Homespun", [[Interface\AddOns\ElvUI\media\fonts\Homespun.ttf]], ruRU + western + zhCN)
