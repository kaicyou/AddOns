...
LSM:Register("font", "Wa Wa", [[Interface\AddOns\ElvUI\media\fonts\Baby.ttf]], zhCN)
LSM:Register("font", "FZ BeiWeiKai", [[Interface\AddOns\ElvUI\media\fonts\FZBWKai.ttf]], zhCN)
LSM:Register("font", "ZQ Xing", [[Interface\AddOns\ElvUI\media\fonts\ZQYBXing.ttf]], zhCN)
