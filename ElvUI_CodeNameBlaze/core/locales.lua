...
--
--	This file contains localization code for CodeNameBlaze
------------------------------------------------------------]]--
...
L["%s version %s by Blazeflack @ Darksorrow-EU"] = true;
L["A profile for 'AffDots' has been created."] = true;
L["A profile for 'DBM' has been created."] = true;
...
L["Click the button that matches your resolution. %s will then re-position (and resize if using low resolution) various elements according to the chosen resolution. If you use a resolution lower than 1920x1080 then you should choose 'Low Resolution'"] = true;
...
L["Credit"] = true;
L["DBM is not enabled, aborting."] = true;
L["DBM Profile Created"] = true;
...
L["Set Bag/Bank backdrop to use the transparent template."] = true;
L["Set Bag/Bank buttons to use the transparent template."] = true;
...
L["The AddOn 'DBM' is not enabled. Profile not created."] = true;
...
L["This step repositions various elements based on your resolution. Your current resolution is %s, this is considered a %s resolution. You need to complete this step if you want your UI to look similar to previews of %s."] = true;
