...
module.db.findspecspells = is6 and {
...
module.db.spell_isTalent = is6 and {		-- SpellID талантов
...
module.db.spell_charge_fix = is6 and {		--Спелы с зарядами
	[161642]=1,
...
module.db.spell_durationByTalent_fix = is6 and {	--Изменение длительности талантом\глифом   вид: [спелл] = {spellid глифа\таланта, изменение времени (-10;10;*0.5;*1.5)}
	[31884] = {53376,"*1.5"},
	[31842] = {53376,"*1.5"},
	[76577] = {56819,2},
	[1719] = {94374,"*1.5"},
...
module.db.spell_cdByTalent_fix = is6 and {		--Изменение кд талантом\глифом   вид: [спелл] = {spellid глифа\таланта, изменение времени (-60;60);spellid2,time2;spellid3,time3;...}
	[498] = {114154,"*0.5"},
...
module.db.tierSetsSpells = is6 and {	--[specID.tierID.tierMark] = {2P Bonus Spell ID, 4P Bonus Spell ID}
...
module.db.tierSetsList = is6 and {	-- [itemID] = specID.tierID.tierMark
...
module.db.spell_talentReplaceOther = is6 and {		--Спелы, показ которых нужно убрать при наличии таланта (талант заменяет эти спелы) [spellID] = [talent Spell ID]
	[85673] = 114163,
	[3411] = 114029,
	[853] = 105593,
	[34433] = 123040,
...
module.db.spell_aura_list = is6 and {		--Спелы, время действия которых отменять при отмене бафа 	[buff_sid] = spellID
	[109964]=109964,
	[33206]=33206,
	[47788]=47788,
	[6940]=6940,
...
module.db.spell_reduceCdByHaste = is6 and {	--Заклинания, кд которых уменьшается хастой
...
module.db.spell_resetOtherSpells = is6 and {	--Заклинания, которые откатывают другие заклинания
	[11958]={45438,122},
...
module.db.spell_sharingCD = is6 and {		--Заклинания, которые запускают кд на другие заклинания 	[spellID] = {[otherSpellID] = CD}
	[102060]={[6552]=15,},
	[6552]={[102060]=15,},
...
module.db.spell_reduceCdCast = is6 and {	--Заклинания, применение которых уменьшает время восстановления других заклинаний
...
module.db.spell_increaseDurationCast = is6 and {	--Заклинания, продляющие время действия
...
module.db.spell_startCDbyAuraFade = is6 and {	--Заклинания, кд которых запускается только при спадении ауры
	[89485]=true,
	[132158]=true,
	[34477]=true,
} or {
...
module.db.spell_reduceCdByAuraFade = is6 and {	--Заклинания, кд которых уменьшается при спадении ауры до окончания времени действия. !Важно обязательное время действия для таких заклинаний
...
module.db.def_col = is6 and {			--Стандартные положения в колонках
	["31821;2"]=1,
	["62618;2"]=1,
	["97462;2"]=1,
	["97462;3"]=1,
...
function moduleInspect:addonMessage()
