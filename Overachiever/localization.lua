...
L["ACH_LETITSNOW_COMPLETE"] = "Handvoll Schneeflocken wurde bereits verwendet"
L["ACH_LETITSNOW_INCOMPLETE"] = "Handvoll Schneeflocken muss noch verwendet werden"
...
L["OPT_ANGLERTIPS_TIP"] = "Einen Hinweis im Tooltip von Fischschwärmen, die zu diesem Erfolg gehören, anzeigen, wenn dieser Erfolg noch nicht abgeschlossen ist."
-- L["OPT_AUTOTRACK_CRITERIATOAST"] = ""
-- L["OPT_AUTOTRACK_CRITERIATOAST_TIP"] = ""
L["OPT_AUTOTRACKEXPLORE"] = "Erkundungs-Erfolge beim Reisen automatisch nachverfolgen"
L["OPT_AUTOTRACKEXPLORE_COMPLETED"] = "Abgeschlossene Erfolge inkludieren"
...
L["OPT_CONSUMEITEMTIPS"] = "Zum Tooltip hinzufügen ob ein Gegenstand noch konsumiert werden muss oder nicht."
L["OPT_CONSUMEITEMTIPS_TIP"] = "Wenn der Erfolg noch nicht abgeschlossen ist, dem Tooltip die Anzeige hinzufügen, ob der jeweilige Gegenstand – sofern er den Kriterien entspricht – noch konsumiert werden muss."
L["OPT_CONSUMEITEMTIPS_TIP2"] = "Bei Gegenständen, für die Du eine zu geringes Stufe hast, um sie konsumieren zu können, wird keine Benachrichtigungston ausgelöst."
...
L["OPT_CRITTERTIPS_TIP"] = "Einen Hinweis im Tooltip von Tieren, die zu diesem Erfolg gehören, anzeigen, wenn dieser Erfolg noch nicht abgeschlossen ist."
L["OPT_DRAG_ACHFRAME"] = "Erfolge"
L["OPT_DRAG_ACHTRACKER"] = "Erfolg-Tracker"
...
L["OPT_FISTFULOFLOVETIPS_TIP"] = "Einen Hinweis im Tooltip von Spielern einer entsprechenden Volks-/Klassenkombination, die zu diesem Erfolg gehören, anzeigen, wenn dieser Erfolg noch nicht abgeschlossen ist."
...
L["OPT_LETITSNOWTIPS"] = "Hinzufügen ob du eine Handvoll Schneeflocken noch auf einen Spieler anwenden musst oder nicht."
L["OPT_LETITSNOWTIPS_TIP"] = "Einen Hinweis im Tooltip von Spielern einer entsprechenden Volks-/Klassenkombination, die zu diesem Erfolg gehören, anzeigen, wenn dieser Erfolg noch nicht abgeschlossen ist."
...
L["OPT_PESTCONTROLTIPS_TIP"] = "Falls dieser Erfolg noch nicht abgeschlossen ist, wird im Tooltip des Ungeziefers angezeigt, ob es bereits getötet wurde."
...
L["OPT_SHOWPROGRESS_OTHER_TIP"] = "Fügt deinen Fortschritt hinzu, wenn die gezeigte Erfolgsinformation von einem anderen Spieler kommt."
L["OPT_SHOWPROGRESS_TIP"] = "Fügt deinen Fortschritt hinzu, wenn der Erfolg ein mengenbasierendes Kriterium enthält, wie zum Beispiel \"Erhalte 10 Reittiere.\""
...
L["OPT_UI_REQUIREDFORMETATIP"] = "Im Tooltip anzeigen, ob dieser Erfolg für weitere benötigt wird"
...
L["OPT_UI_SERIESTIP_TIP"] = "Wenn der Mauscursor über einem Erfolg ist, der zu einer Reihe angehört, werden alle dazugehörigen Erfolge ebenfalls aufgelistet."
L["OPT_WELLREADTIPS"] = "Im Tooltip anzeigen, ob dieses Buch bereits gelesen wurde oder nicht."
L["OPT_WELLREADTIPS_TIP"] = "Einen Hinweis im Tooltip von Büchern, die zu diesem Erfolg gehören, anzeigen, wenn dieser Erfolg noch nicht abgeschlossen ist."
...
L["SOUND_ALARM1"] = "Alarmton 1"
L["SOUND_ALARM2"] = "Alarmton 2"
L["SOUND_ALARM3"] = "Alarmton 3"
