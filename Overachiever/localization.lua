...
L["PROGRESSIFOTHERCOMPLETED"] = "%s's Fortschritt:"
...
L["OPT_ANGLERTIPS_TIP_ALWAYS"] = "일부 물고기떼에서 낚시할 때 툴팁에 업적에 포함되는지 표시합니다." -- Needs review
...
L["OPT_LABEL_DRAENORANGLER"] = "\\\"%s\\\"의 하위 업적" -- Needs review
...
L["OPT_SELECTSOUND_CHECKCOMBAT"] = "몹과 전투중이라면 죽임을 포함" -- Needs review
L["OPT_SELECTSOUND_CHECKCOMBAT_TIP"] = "전투중 필요에 의해 몹을 죽이는 경우 소리를 재생하지 않습니다." -- Needs review
...
L["RECENTREMINDERCRITERIA"] = "최근 진행한 목표:" -- Needs review
L["REQUIREDFORMETATIP"] = "아래 업적이 요구함:"
L["SERIESTIP"] = "업적 세트:"
L["SOUND_AGGRO_PULLED"] = "위협수준 획득" -- Needs review
