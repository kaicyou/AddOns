...
L["SEARCH_HELP"] = "Nutze diese Seite, um nach Erfolgen zu suchen. Per Slash-Befehl kannst du auch nach Erfolgen per Name oder ID suchen. Lies die Datei readme.txt für weitere Details."
L["SEARCH_NAME"] = "Name:"
...
L["SUGGESTIONS_HELP"] = "Hier werden Erfolge aufgelistet, die Du in deiner aktuellen Zone abschließen kannst. Weiters werden auch alle Erfolge aufgelistet, an die Du in den letzen 2 Minuten per Tooltip erinnert wurdest und auch jene, durch die kürzlich ein Timer gestartet wurde."
...
L["TAB_HELP"] = "|cffffffffStrg-Klick|r auf einen Erfolg, um ihn in der Standard-UI anzuzeigen.|n|nEin |cffffffffblauer Hintergrund|r bedeutet, dass der Erfolg Teil einer Reihe ist, für die dir noch ein vorheriger Schritt fehlt.|n|nEin |cffffffffroter Hintergrund|r bedeutet, dass der Erfolg nicht im Standard-UI gefunden werden konnte, weil er nur von der gegnerischen Fraktion erlangt werden kann oder eine unerreichte Heldentat ist.|n|nEin |cffffffffgüner Hintergrund|r zeigt an, dass Du kürzlich im Tooltip an diesen Erfolg erinnert wurdest, oder dass dieser Erfolg einen kürzlich gestarteten Timer hat."
...
L.SUBZONES = {
	...
	["The Colossal Forge"] = "Die kolossale Schmiede", -- Needs review
