...
L["SEARCH_NAME"] = "Nom :" -- Needs review
...
L["TAB_HELP"] = "|cffffffffCtrl-点击|r一个成就跳转到它在标准成就界面的位置。|n|n|cffffffffCtrl-shift-点击|r查看该成就的相关成就。|n|n一个|cffffffff蓝色背景|r表示此成就是你还没有完成前续内容的系列成就。|n|n一个|cffffffff红色背景|r表示此成就无法在当前人物的标准成就界面中找到，因为这是阵营专属成就，或是无法取得的‘光辉事迹’成就。|n|n一个|cffffffff绿色背景|r表示该成就在‘最近的提醒’列表。 它会在过去的2分钟内变得特别重要 (列如：因为他的计时器或者目标会显示在鼠标提示上)。" -- Needs review
L["TAB_SORT"] = "排序："
...
L["SEARCH_NAME"] = "Название:" -- Needs review
...
L["SEARCH_NAME"] = "Nombre:" -- Needs review
