...
L["RELATED_HELP"] = "Эта вкладка показывает достижения, которые связаны друг с другом. Одним из достижений было выбрано в качестве базового. Остальные находятся в этой же серий в качестве базового, являются одним из серии базовых, или из другой серии, или иметь в качестве одного из своих собственных критерих, либо базы или достижением в своей серии."
...
L["SUGGESTIONS_HELP"] = "Предполагаемые достижения, указанные здесь, основаны на вашем текущем местоположении. Также перечислены все \"последнее напоминание\" достижений.|n|n|cffffffffShift-правый клик|r предполагаемые достижения для скрытых. (Это персонажно-характерно и влияет на все локации.)"
