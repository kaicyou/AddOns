...
function psinvonwhisper(arg1,arg2,bnet,fullname)

if psdebug then
print ("We use name: "..arg2)
end
	...
	if bil==1 then
      ...
      if(IsInGuild()) then
        ...
        if GetNumGroupMembers()==40 then
          ...
          if bnet==nil then
			  if psdebug then
					print ("Try to invite1: "..arg2)
			  end
			  if fullname and fullname~=arg2 then
				-- invite using fullname too
				  if psdebug then
						print ("Try to invite1: "..fullname)
				  end
				InviteUnit(fullname)
			  end
            InviteUnit(arg2)
			  ...
			  if psdebug then
					print ("Try to invite2: "..temptoinvite)
			  end
