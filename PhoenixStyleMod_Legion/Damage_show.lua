tempdmgshowvar=1
function psdamageshow_legion1(play,ar1,ar2,ar3)
...
if pssidamageinf_indexboss[play][ar1][ar2]==1104 then
  uron=pszzlegiononettaddopttxt16
end
...
function psdamagerep_legion1(chat,play,ar1,ar2,ar3,reptype,quant,zapusk, endcombat)
...
function psdamageshow_legion1_allmerge(play,ar1,ar2,ar3,bosstitle,addemptyline)
  local uron=psiccdmgfrom
  local psstrochka=""
  local ret=0
