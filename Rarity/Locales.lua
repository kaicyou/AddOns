...
L["5-player Event instance"] = "Donjon d'événement à 5 joueurs" -- Needs review
...
L["an item already exists by this name, so it will not be imported"] = "Un objet avec ce nom existe déjà, et ne sera pas importé." -- Needs review
L["an item with the same Item ID already exists, so it will not be imported"] = "Un objet avec le même identifiant d'objet existe déjà, et ne sera pas importé." -- Needs review
L["Announce"] = "Annoncer"
...
L["Classic"] = "Classique"
L["Clear All Exports"] = "Effacer tous les exports" -- Needs review
...
L["%d |4waypoint:waypoints; |4is:are; located inside |4an instance:instances; and |4was:were; not added"] = "%d |4point de navigation:points de navigation; |4est situé:sont situés; dans |4une instance:des instances; et |4n'a pas été ajouté:n'ont pas été ajoutés;." -- Needs review
L["%d |4zone:zones;"] = true
...
Vous pouvez cocher plusieurs cases dans cette liste à la fois.]=] -- Needs review
...
L["Error compressing item pack"] = "Erreur lors de la compression du pack d'objet(s)." -- Needs review
L["Error encoding item pack"] = "Erreur lors du codage du pack d'objet(s)." -- Needs review
L["Error serializing item pack"] = "Erreur lors de la mise en série du pack d'objet(s)." -- Needs review
...
L["Import"] = "Importer"
L["imported successfully"] = "importé avec succès" -- Needs review
L["Import/Export"] = true
...
L["not imported"] = "pas importé" -- Needs review
L["NPCs"] = "ID de PNJs"
...
L["Sorting by zone"] = "Tri par zone" -- Needs review
...
L["will be imported"] = "sera importé" -- Needs review
