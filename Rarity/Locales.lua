...
-- L["A comma-separated list of quest IDs. When these quest IDs are completed, the item is considered defeated."] = ""
...
-- L["Every Quest ID must be a number greater than 0."] = ""
L["Experiment 12-B"] = true
...
-- L["Highmountain Salmon School"] = ""
-- L["Highmountain Tauren"] = ""
-- L["High Priest of Ordos"] = ""
...
-- L["Please enter a comma-separated list of Quest IDs."] = ""
...
-- L["%s: Found after %d attempts!"] = ""
-- L["%s: Found on the first attempt!"] = ""
...
-- L["Toggles"] = ""
L["Tol'vir"] = true
-- L["Tooltip can't be shown in combat"] = ""
...
L["A comma-separated list of quest IDs. When these quest IDs are completed, the item is considered defeated."] = "Une liste d'IDs de quêtes séparés par des virgules. Lorsque ces quêtes seront terminées, l'objet sera considéré comme Vaincu." -- Needs review
...
L["A dungeon ID which, when marked as completed by the game client, will cause this item to be considered Defeated. This is primarily used for holiday items which have unique dungeon IDs."] = "L'ID d'un donjon qui, lorsque signalé comme terminé par le client du jeu, provoquera le statut Vaincu pour cet objet. Ceci est principalement utilisé pour les objets des événements saisonniers qui ont des IDs de donjon uniques." -- Needs review
...
L["Ctrl-Click to change sort order"] = "Clic-Ctrl pour modifier l'ordre d'affichage"
L["Ctrl-Click to create the remaining TomTom waypoint(s)."] = "Clic-Ctrl pour créer le ou les points de navigation TomTom restants"
L["Ctrl-Click to create TomTom waypoint(s)."] = "Clic-Ctrl pour créer un ou des points de navigation TomTom"
L["Cupri"] = true
-- L["Cursed Queenfish School"] = ""
...
L["Defeat Detection"] = "Détection de Vaincu" -- Needs review
L["Defeated"] = "Vaincu"
...
L["Every Quest ID must be a number greater than 0."] = "Tous les IDs de quête doivent être un nombre plus grand que 0." -- Needs review
...
L["Please enter a comma-separated list of Quest IDs."] = "Entrez une liste d'IDs de quêtes séparés de virgules." -- Needs review
...
L["Shift-Click to link your progress to chat"] = "Clic-Maj pour créer un lien de ta progression dans la fenêtre de discussion"
L["Shift-Click to open options"] = "Clic-Maj pour afficher les options"
...
Vous ne pouvez pas changer ce nom après avoir créé l'item, choisissez donc soigneusement.]=]
L["Today"] = "Aujourd'hui"
...
L["Welcome to Rarity r%d. Your settings have been reset."] = "Bienvenue sur Rarity r%d. Ta configuration a été réinitialisée."
...
L["When you move your mouse out of the Rarity tooltip, it will take this long before it automatically hides itself."] = "Le temps nécessaire avant que l'infobulle Rarity ne disparaissent après avoir passé la souris dessus." -- Needs review
...
L["Black Barracuda School"] = "Косяк черной барракуды" -- Needs review
