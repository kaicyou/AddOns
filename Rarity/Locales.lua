...
-- L["Are you sure you want to import the Rarity Item Pack you entered?"] = ""
-- L["Are you sure you want to turn off the Export toggle for all your Custom items?"] = ""
...
-- L["Equal odds"] = ""
-- L["Error compressing item pack"] = ""
-- L["Error encoding item pack"] = ""
-- L["Error serializing item pack"] = ""
...
L["Experiment 12-B"] = true
-- L["Export"] = ""
-- L["Export Rarity Item Pack"] = ""
-- L["Export this item"] = ""
-- L["Eye of Inquisition"] = ""
-- L["Faintly Glowing Flagon of Mead"] = ""
...
-- L["Import"] = ""
-- L["imported successfully"] = ""
-- L["Import/Export"] = ""
-- L["Import Rarity Item Pack"] = ""
...
-- L["Paste a Rarity Item Pack String here using Ctrl-V, then click the Import button."] = ""
...
-- L["Put \"Rarity:\" on a separate line"] = ""
...
L["The Burning Crusade"] = true
-- L["The following %d item(s) have been selected to export:"] = ""
...
-- L["The selected Rarity Item Pack string is invalid."] = ""
...
-- L["This tab lets you import and export items into and out of your Custom tab."] = ""
...
-- L["Type of item"] = ""
-- L["Unable to retrieve item information from the server"] = ""
...
-- L["(Warning: item could not be retrieved from server)"] = ""
...
-- L["When on, items that have no attempts yet will be hidden from the tooltip."] = ""
...
-- L["When on, the text \"Rarity:\" will be put on its own line in world and item tooltips."] = ""
...
L["A comma-separated list of item IDs which, when used or opened, can give you this item. Use WowHead or a similar service to lookup item IDs."] = "Une liste d'identifiants d'objets qui, lorsque utilisés ou ouverts, peuvent vous donner cet objet. Utilisez WowHead ou un service similaire pour trouver les identifiants des objets."
L["A comma-separated list of NPC IDs who drop this item. Use WowHead or a similar service to lookup NPC IDs."] = "Une liste d'identifiants des PNJ qui laissent tomber cet item. Utilisez WowHead ou un service similaire pour trouver les identifiants des PNJ."
L["A comma-separated list of quest IDs. When these quest IDs are completed, the item is considered defeated."] = "Une liste d'identifiants de quêtes séparés par des virgules. Lorsque ces quêtes seront terminées, l'objet sera considéré comme Vaincu." -- Needs review
L["A comma-separated list of Statistic IDs that track the number of kills toward obtaining this item."] = "Une liste d'identifiants de statistiques séparés par des virgules qui suit le nombre de mises à mort pour obtenir cet objet." -- Needs review
L["A comma-separated list of Statistic IDs that track the number of kills toward obtaining this item. These statistics will be added together. Use WowHead or a similar service to locate statistic IDs."] = "Une liste d'identifiants de statistiques séparés par des virgules qui suit le nombre de mises à mort pour obtenir cet objet. Ces statistiques seront combinées. Utilisez WowHead ou un service similaire pour obtenir les identifiants de statistiques." -- Needs review
L[ [=[A comma-separated list of the zones or sub-zones this item can be found in. For zones, you can enter either the Map ID (i.e. 811 is Vale of Eternal Blossoms), or the full name of the zone. For sub-zones, you must enter the full name of the sub-zone.
...
L["%d |4waypoint:waypoints; |4is:are; located inside |4an instance:instances;"] = "%d |4point de navigation:points de navigation; |4est situé:sont situés; dans |4une instance:des instances;."
L["%d |4zone:zones;"] = true
...
L["Every Quest ID must be a number greater than 0."] = "Tous les identifiants de quête doivent être un nombre plus grand que 0." -- Needs review
...
L["Please enter a comma-separated list of Quest IDs."] = "Veuillez entrer une liste d'identifiants de quêtes séparés par des virgules." -- Needs review
...
L["Shift-Click to link your progress to chat"] = "Clic-Maj pour créer un lien de votre progression dans la fenêtre de discussion."
...
L["When enabled, Rarity will add obtainable items to game tooltips whenever possible."] = "Ajoute les objets accessibles aux infobulles en jeu dès que cela est possible." -- Needs review
...
L["When on, items marked as Unavailable will be hidden from the tooltip. This way, items requiring a certain holiday will automatically be hidden when the holiday is not active."] = "Cache les objets marqués comme Indisponible de l'infobulle. De cette façon, les objets nécessitant un événement mondial particulier seront automatiquement cachés lorsque l’événement n'est pas en cours."
-- L["When on, items that have no attempts yet will be hidden from the tooltip."] = ""
L["When on, Rarity will remind you to go farm holiday items you're missing if the holiday is active and the item is set as Undefeated. (This only works for items that originate from holiday dungeons or daily quests.) The reminder occurs each time you log in or reload your UI, and stops for the day once you defeat the holiday dungeon or complete the\009quest."] = "Si activé, Rarity vous rappellera d'aller à la recherche des objets d’événements saisonniers qu'il vous manque si l’événement est actif et que l'objet est perçu comme Invaincu. (Cela ne marche que pour les objets provenant des donjons ou des quêtes journalières de l'évènement). Le rappel se fait à chaque connexion ou rechargement de l'interface, et cesse pour la journée au cours de laquelle vous terminez le donjon ou la quête de l'évènement."
