...
function R:PrepareDefaults()
   ...
   groups = {
    ...
    mounts = {
     ...
     ["Ironhoof Destroyer"] =                            { cat = WOD, type = MOUNT, method = BOSS, name = L["Ironhoof Destroyer"], spellId = 171621, itemId = 116660, npcs = { 99999 }, tooltipNpcs = { 77325 }, chance = 100, wasGuaranteed = true, groupSize = 3, statisticId = { 9365 }, lockBossName = "Warlord Blackhand", coords = { {m=988,f=5,x=48.4,y=34.5,i=true} }, },
