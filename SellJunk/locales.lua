...
L["Command accepts only itemlinks."] = "Befehlt akzeptiert nur Gegenstandslinks."
L["copper"] = "Kupfer"
...
L["Added"] = "Aggiunto" -- Needs review
L["Add item"] = "Aggiungi oggetto" -- Needs review
L["Automatically sell junk"] = "Vendi automaticamente oggetti grigi" -- Needs review
L["Clear"] = "Vuota" -- Needs review
L["Clear exceptions"] = "Vuota eccezioni" -- Needs review
L["Command accepts only itemlinks."] = "Il comando accetta solo link a oggetti" -- Needs review
L["copper"] = "bronzo" -- Needs review
L["Destroyed"] = "Distrutto" -- Needs review
L["Drag item into this window to add/remove it from exception list"] = "Trascina un oggetto in questa finestra per aggiungerlo/rimuoverlo dalla lista delle eccezioni" -- Needs review
L["Exceptions"] = "Eccezioni" -- Needs review
L["Exceptions succesfully cleared."] = "Eccezioni cancellate con successo." -- Needs review
L["Gained"] = "Guadagnati" -- Needs review
L["gold"] = "oro" -- Needs review
L["<Item Link>"] = "<Link Oggetto>" -- Needs review
L["Prints itemlinks to chat, when automatically selling items."] = "Scrivi nella chat i link agli oggetti quando vendi automaticamente gli oggetti." -- Needs review
L["Removed"] = "Rimosso" -- Needs review
L["Remove item"] = "Rimuovi oggetto" -- Needs review
L["Removes all exceptions."] = "Rimuove tutte le eccezioni" -- Needs review
L["Sell Junk"] = "Vendi grigi" -- Needs review
L["Sell max. 12 items"] = "Vendi max. 12 oggetti" -- Needs review
L["Show gold gained"] = "Mostra oro ottenuto" -- Needs review
L["Show 'item sold' spam"] = "Visualizza le scritte 'oggetto venduto'" -- Needs review
L["Shows gold gained from selling trash."] = "Mostra oro ottenuto vendendo oggetti inutili" -- Needs review
L["silver"] = "argento" -- Needs review
L["Sold"] = "Venduti" -- Needs review
L["This is failsafe mode. Will sell only 12 items in one pass. In case of an error, all items can be bought back from vendor."] = "Questa è la modalità anti-errore. Verranno venduti solo 12 oggetti per volta. In caso di errore, potranno essere tutti ricomprati dal venditore." -- Needs review
L["Toggles the automatic selling of junk when the merchant window is opened."] = "Attiva la vendita dei grigi automatica quando viene aperta la finestra di un mercante." -- Needs review
...
L["Clear"] = "清空全局例外物品列表" -- Needs review
L["Clear exceptions"] = "清除例外物品" -- Needs review
L["Command accepts only itemlinks."] = "命令只能使用物品链接" -- Needs review
L["copper"] = "铜" -- Needs review
L["Destroyed"] = "已摧毁" -- Needs review
L["Drag item into this window to add/remove it from exception list"] = "拖动物品到这个窗口可将其添加到例外物品列表或从中删除" -- Needs review
L["Exceptions"] = "全局例外" -- Needs review
L["Exceptions succesfully cleared."] = "全局例外列表已清空" -- Needs review
L["Gained"] = "获得：" -- Needs review
L["gold"] = "金" -- Needs review
L["<Item Link>"] = "<物品链接>" -- Needs review
L["Prints itemlinks to chat, when automatically selling items."] = "当自动贩卖物品后，在聊天框中显示贩卖物品的链接" -- Needs review
L["Removed"] = "已移除" -- Needs review
L["Remove item"] = "移除物品：" -- Needs review
L["Removes all exceptions."] = "移除所有的全局例外物品" -- Needs review
L["Sell Junk"] = "卖垃圾" -- Needs review
L["Sell max. 12 items"] = "一次出售12件物品" -- Needs review
L["Show gold gained"] = "显示获得金币" -- Needs review
L["Show 'item sold' spam"] = "显示贩卖物品时的详情信息" -- Needs review
L["Shows gold gained from selling trash."] = "显示出售垃圾获得的金币" -- Needs review
L["silver"] = "银" -- Needs review
L["Sold"] = "售出：" -- Needs review
L["This is failsafe mode. Will sell only 12 items in one pass. In case of an error, all items can be bought back from vendor."] = "安全模式：一次只出售12件物品，卖出后可以重新买回错误出售的物品" -- Needs review
