...
InitializeFrames('Stormkeeper',LargeIconGrpBot,[[elemental\stormkeeper]],lgIcon,lgGlow,true)
...
AuraGroup:SetScript('OnMouseDown',function(self,button)
	if (Auras.db.char.elements[1].isMoving) then
		Auras:MoveOnMouseDown(self,'AuraGroupEle',button)
	end
end)
...
_G['SSA_SmallIconGrpRightEle'] = SmallIconGrpRight
...
-- Casting Status Bar
local ChannelBar = CreateFrame('StatusBar','ChannelBarEle',AuraGroup)
...
SSA.ChannelBarEle = ChannelBar

-- Casting Status Bar
local CastBar = CreateFrame('StatusBar','CastBarEle',AuraGroup)
...
SSA.CastBarEle = CastBar
_G['SSA_CastBarEle'] = CastBar
...
local buffIDs = {
	[114050] = {
		[1] = SSA.AscendanceBarEle,
		[2] = 'ascendance',
	},
	[108281] = {
		[1] = SSA.AncestralGuidanceBarEle,
		[2] = 'ancestralGuidance',
	},
	[108271] = {
		[1] = SSA.AstralShiftBarEle,
		[2] = 'astralShift',
	},
	[2825] = {
		[1] = SSA.BloodlustBarEle,
		[2] = 'bloodlust',
	},
	[118522] = {
