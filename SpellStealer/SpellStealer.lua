...
function SS_OnLoad(self)
	...
	SLASH_SPELLSTEALER1 = "/sstealer"
	SLASH_SPELLSTEALER2 = "/ss"
	SlashCmdList["SPELLSTEALER"] = SS_handleCmd
...
function SSFrameUpdate()
	...
	while buffName do
		...
		i = i+1
		buffName, _, _, _, _, _, expireTime, _, isStealable = UnitAura("target", i, "HELPFUL")
	end
	if (debug == true) then
