...
L["S_GROUPFINDER_KICK_DESC"] = "When you are the group leader, the addon may ask to kick an afk player or a player that are too far away from the quest location."
...
L["S_GROUPFINDER_RIGHTCLICKCLOSE"] = "right click to close this panel"
