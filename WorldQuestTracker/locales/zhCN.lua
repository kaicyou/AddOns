...
L["S_GROUPFINDER_ACTIONS_SEARCHMORE"] = "点击寻找更多小队成员"
L["S_GROUPFINDER_ACTIONS_SEARCHOTHER"] = "离开并寻找其他的小队？"
L["S_GROUPFINDER_ACTIONS_UNAPPLY1"] = "点击拒绝申请，以便于我们可以创建新小队"
L["S_GROUPFINDER_ACTIONS_UNLIST"] = "点击以后不再列表中列出你的当前小队"
L["S_GROUPFINDER_ACTIONS_UNLISTING"] = "隐藏中..."
L["S_GROUPFINDER_ACTIONS_WAITING"] = "等待中..."
L["S_GROUPFINDER_ENABLED"] = "接到新任务时自动启用"
L["S_GROUPFINDER_KICK_DESC"] = "当你是小队队长，插件将询问你是否踢掉离线或离任务地点太远的成员"
L["S_GROUPFINDER_LEAVEOPTIONS"] = "离开小队选项"
L["S_GROUPFINDER_LEAVEOPTIONS_AFTERX"] = "X 秒以后离开"
L["S_GROUPFINDER_LEAVEOPTIONS_ASKX"] = "不要自动离开，只需给出提示 X 秒"
...
L["S_GROUPFINDER_QUEUEBUSY"] = "你已经在申请队列中。"
--Translation missing 
-- L["S_GROUPFINDER_RESULTS_APPLYING"] = ""
--Translation missing 
-- L["S_GROUPFINDER_RESULTS_APPLYING1"] = ""
L["S_GROUPFINDER_RESULTS_FOUND"] = "找到 %d 个小队，点击申请加入"
L["S_GROUPFINDER_RESULTS_FOUND1"] = "找到 1 个小队，点击申请加入"
--Translation missing 
-- L["S_GROUPFINDER_RESULTS_UNAPPLY"] = ""
L["S_GROUPFINDER_RIGHTCLICKCLOSE"] = "点击右键关闭面板"
L["S_GROUPFINDER_SECONDS"] = "秒"
L["S_GROUPFINDER_TITLE"] = "小队寻找"
--Translation missing 
